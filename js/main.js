...
var promisesArray = [
    Setup.importData('../data/times.json'), 
    Setup.importData('../datacustom.geo.json'), 
    Setup.importData('../data/combined_points.json'),
    Setup.importData('../data/PB2002_plates.json')
];
